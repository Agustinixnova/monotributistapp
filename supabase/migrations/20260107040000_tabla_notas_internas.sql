...
-- Politica SELECT: Solo contadoras
...
-- Politica INSERT: Solo contadoras
...
-- Politica UPDATE: Solo contadoras
...
-- Politica DELETE: Solo contadoras
...
-- 4. Funcion para obtener notas de un cliente
...
-- 5. Funcion para obtener recordatorios pendientes
...
COMMENT ON COLUMN public.client_notas_internas.tipo IS 'general=nota comun, facturacion=sobre facturacion, urgente=prioridad alta, recordatorio=con fecha';
