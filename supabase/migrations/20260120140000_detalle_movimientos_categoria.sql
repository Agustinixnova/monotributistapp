-- Migración: Detalle de movimientos por categoría
-- Descripción: Función RPC para obtener movimientos detallados de una categoría específica
...
-- Permisos
GRANT EXECUTE ON FUNCTION public.caja_detalle_movimientos_categoria(UUID, UUID, VARCHAR, DATE, DATE) TO authenticated;

-- Comentario
COMMENT ON FUNCTION public.caja_detalle_movimientos_categoria IS 'Obtiene el detalle de movimientos de una categoría específica';
