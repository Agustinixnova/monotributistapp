-- Migración Fix: Corregir nombres de columnas en funciones de reportes por categoría
-- Las columnas correctas son duenio_id/empleado_id (no employer_id/employee_id)

-- ============================================
-- FUNCIÓN: Reporte de Ingresos por Categoría (CORREGIDA)
-- ============================================
...
-- ============================================
-- FUNCIÓN: Reporte de Egresos por Categoría (CORREGIDA)
-- ============================================
