...
-- Ir a: SQL Editor → New Query → Pegar este código → Run
-- =============================================
...
-- PASO 3: Inicializar fecha_alta_sistema para clientes existentes
UPDATE public.client_fiscal_data
SET fecha_alta_sistema = DATE(created_at)
WHERE fecha_alta_sistema IS NULL;

-- PASO 4: Función CORREGIDA para calcular estado de pago
...
-- PASO 5: Trigger para ajustar deuda inicial al registrar pagos
...
-- PASO 7: Actualizar todos los estados de pago
UPDATE public.client_fiscal_data
