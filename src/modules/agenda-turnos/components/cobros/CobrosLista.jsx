        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {cobros.map(cobro => {
              ...
              // Formatear fecha del cobro de YYYY-MM-DD a DD/MM/YYYY
              const fechaCobro = cobro.fecha_pago
              const [year, month, day] = fechaCobro.split('-')
              const fechaFormateada = `${day}/${month}/${year}`

              // Formatear hora del cobro (HH:MM)
              const horaCobro = cobro.hora_pago ? cobro.hora_pago.substring(0, 5) : null
