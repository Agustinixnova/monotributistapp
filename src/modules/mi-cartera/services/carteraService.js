...
export async function getCarteraClientes(userId, userRole, filters = {}) {
  ...
  let queryConFiscal = supabase
    ...
    .select(`
      ...
      monto_deuda_monotributo,
      cuotas_adeudadas_monotributo,
      servicios_delegados,
      obra_social,
    ...
    if (!errorPerfiles && perfilesClientes) {
      ...
      clientesSinFiscal = perfilesConRolCliente
        ...
        .map(p => ({
          ...
          monto_deuda_monotributo: null,
          cuotas_adeudadas_monotributo: null,
  ...
  const clientes = clientesRaw.map(c => ({
      ...
      monto_deuda_monotributo: c.monto_deuda_monotributo,
      cuotas_adeudadas_monotributo: c.cuotas_adeudadas_monotributo,
