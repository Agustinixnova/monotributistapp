    ...
    <div className="fixed top-4 left-4 right-4 z-50 animate-slide-down md:left-auto md:right-4 md:w-96">
      <div className="bg-violet-600 text-white rounded-2xl shadow-2xl p-4">
        ...
        <div className="flex gap-2 mt-4">
          <button
            onClick={handleDismiss}
            className="flex-1 px-4 py-2 text-sm font-medium text-violet-100 bg-violet-500 rounded-xl hover:bg-violet-400 transition-colors"
          >
            Después
          </button>
          <button
            onClick={handleUpdate}
            className="flex-1 px-4 py-2 text-sm font-medium text-violet-600 bg-white rounded-xl hover:bg-violet-50 transition-colors flex items-center justify-center gap-2"
          >
